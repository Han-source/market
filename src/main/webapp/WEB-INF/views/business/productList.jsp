                            ...
                            <c:forEach var="attachVoInStr" items="${product.attachListInGson}" varStatus="sta">
                              <script>
                                 $(document).ready(function() {
                                    imageList('<c:out value="${product[status.index].attachListInGson[sta.index]}" />', '<c:out value="${product[status.index].listAttach[sta.index].uuid}" />', '<c:out value="${product[status.index].id}" />');
                                 });
                              </script>                     
                           </c:forEach>
                        </ul>
